...
namespace CoFiSo
{
    ...
    /// </summary>
    public partial class AdvancedCollectionView : IAdvancedCollectionView, INotifyPropertyChanged, IComparer<object>
    {
        private readonly List<object> _view;

        private readonly ObservableRangeCollection<SortDescription> _sortDescriptions;
        ...
        public AdvancedCollectionView(IList source, bool isLiveShaping = false)
        {
            ...
            _sortDescriptions = new ObservableRangeCollection<SortDescription>();
